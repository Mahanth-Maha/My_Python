...
int main(void)
{
    ...
    *p = 0;
    ...
    if (childPID >= 0) // fork was successful
    {
        ...
        {
            printf("\n Child Process Initial Value :: localVar = %d, globalVar = %d", localVar,globalVar);
            localVar++;
            globalVar++;
  
            int c = 500;
            printf("\n Child Process :: localVar = %d, globalVar = %d", localVar, globalVar);
        ...
        {
            printf("\n Parent process Initial Value :: localVar = %d, globalVar = %d",localVar, globalVar);
  
            localVar = 10;
            globalVar = 20;
            printf("\n Parent process :: localVar = %d, globalVar = %d", localVar, globalVar);
